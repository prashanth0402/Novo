    ...
    <div>
        ...
        <v-layout row wrap class="mb-5 mt-3" style="padding-left: 12px;">
            <div class="d-flex align-center">
                <v-img src="https://flattrade.s3.ap-south-1.amazonaws.com/promo/gseclogo.png" height="30" width="30" contain
                    class="d-flex"></v-img>
        ...
        <v-layout class="my-10" v-if="goidynamicItem.length == 0">
            <v-slide-x-transition mode="out-in" appear>
                <v-flex class="ml-5 text text--disabled">
                    <!-- <p v-if="Flag == 'I'">No GOIs are open for sale currently.</p>
                    <p v-if="Flag == 'O'">You haven't invested in any GOIs.</p> -->
                    <p>{{ goidynamicText }}</p>
                </v-flex>
        ...
        <v-card class="elevation-0" v-if="goidynamicItem.length != 0">
            <v-card-title>
            ...
            <v-slide-x-transition mode="out-in" appear>
                <v-data-table :headers="goidynamicHeader" :items="goidynamicItem" :search="search" :items-per-page="10"
                    :key="tableKey"
                    ...
                    <template v-slot:item.symbol="{ item }" v-if="goiresult != [] && Flag == 'I'">
