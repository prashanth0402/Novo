...
// Date: 12JUNE2023
// */
// func ReverseProcess(pExchangeReq bsesgb.SgbReqStruct, pExchangeResp bsesgb.SgbRespStruct, pReqRec SgbReqStruct, pClientId string, pJvStatusRec JvStatusStruct, pJvDataStruct JvDataStruct, pClientEmail string, pExchange string) (string, error) {
...
// 				lExchangeResp, lErr4 := exchangecall.ApplySgb(lExchangeReq, pClientId, pExchange)
// 				if lErr4 != nil {
